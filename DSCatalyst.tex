...
that of {\emph{Algorithms}} and {\emph{Models}}.
But, alongside this new way of working, is the simple downside that it is 
...
a profound impact on the way that computational science is performed,
...
This will be achieved over a period of six months, including regular meetings
...
\item We have costed six separate week-long visits to Cambridge for
  Crick: his direct buy-out costs for a week are \pounds 350
totalling (covering seven hours of teaching);  One week's hotel: seven
nights in Cambridge at c.\pounds 130 = \pounds 910; one week's
subsistence: seven days at \pounds 25 = \pounds 200; round trip
travel: \pounds 180; (one individual trip costing \pounds 1600): \hfill {\textbf{\pounds 9,600}}

\item Programmer to implement the system \hfill {\textbf{\pounds 5,000}}
